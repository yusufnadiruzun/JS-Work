...
async function returnValue(){
    var value = currency.options[currency.selectedIndex].value;
    const url = "http://api.exchangeratesapi.io/v1/latest?access_key=d65d8547cccd0b3d45c7b59c070e58a6&format=1&symbols= " + value ;
    const response = await fetch(url);
    const responsedata = await response.json();
    console.log(console.log(Object.values(responsedata.rates)[0]));
